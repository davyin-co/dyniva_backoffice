...
use Drupal\views_add_button\Plugin\views\field\ViewsAddButtonField;
use Drupal\Core\Url;
 ...
 *
 * @ViewsAddButton(
 *   id = "views_add_button_taxonomy_manage",
 *   label = @Translation("ViewsAddButtonTaxonomy"),
 *   target_entity = "taxonomy_term"
 * )
 */
class ViewsAddButtonTaxonomy extends ViewsAddButtonField {
  ...
  public static function generateUrl($entity_type, $bundle, array $options, $context = '') {
    ...
    $url = Url::fromRoute('manage.entity.taxonomy_term.add_form', ['taxonomy_vocabulary' => $bundle], $options);
    return $url;
  }
